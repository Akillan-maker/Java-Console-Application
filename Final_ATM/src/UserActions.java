...
//                transaction();
    ...
    void withdraw()
    {
        ...
        double twoThousand = in.nextInt();
//        note.add(twoThousand);
        System.out.println("Enter the no of 500 note: ");
        double fiveHundred = in.nextInt();
//        note.add(fiveHundred);
        System.out.println("Enter the no of 50 note: ");
        double fifty = in.nextInt();
        if ((2000*twoThousand)+(500*fiveHundred)+ (50*fifty)==(withdrawAmount)){
            note.add(String.valueOf(twoThousand));
            note.add(String.valueOf(fiveHundred));
            note.add(String.valueOf(fifty));
            for (int i = 0; i < userList.size(); i++)
          {
              if (userList.get(i).getId().equals(inId))
              {
            ...
            System.out.println("Invalid count...Retry");
...
//        note.add(fiveHundred);
        System.out.println("Enter the no of 50 note: ");
        double fifty = in.nextInt();
        if ((2000*twoThousand)+(500*fiveHundred)+ (50*fifty)==(depositAmount)){
            note.add(String.valueOf(twoThousand));
            note.add(String.valueOf(fiveHundred));
            note.add(String.valueOf(fifty));
//            double depositAmount = in.nextDouble();
